...
1. Which technologies has been used?
...
2. Why 1 project with 2 apps instead of 2 separate projects?
...
3. What would I do if these was a real applications that will be deployed?
...
4. How did you handle high data volumes in the project?
...
5. Why did you choose MySQL over NoSQL databases?
...
7. How do you ensure data integrity and fault tolerance?
...
#### **Why 1 Project with 2 Apps Instead of Separate Projects?**
...
### You can send request via socket std lib
...
### You also can nmap 's ncat.exe (Windows)
